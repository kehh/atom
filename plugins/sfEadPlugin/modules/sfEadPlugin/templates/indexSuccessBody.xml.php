...
<eadheader langencoding="iso639-2b" countryencoding="iso3166-1" dateencoding="iso8601" repositoryencoding="iso15511" scriptencoding="iso15924" relatedencoding="DC">
  ...
  <filedesc>
    <titlestmt>
      ...
      <titleproper encodinganalog="Title"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></titleproper>
      <?php endif; ?>
      ...
      <author encodinganalog="Creator"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($note)) ?></author>
      <?php endforeach; ?>
      <?php endif; ?>
    </titlestmt>
    <?php
    ...
    <editionstmt>
      <edition><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></edition>
    </editionstmt>
    <?php endif; ?>
    <?php if ($value = $resource->getRepository()): ?>
    <publicationstmt>
      <publisher encodinganalog="Publisher"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value->__toString())) ?></publisher>
<?php if ($address = $value->getPrimaryContact()): ?>
      ...
      <?php endif; ?>
      <date normal="<?php echo $publicationDate ?>" encodinganalog="Date"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($publicationDate)) ?></date>
  ...
  <profiledesc>
    ...
    <descrules encodinganalog="3.7.2"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($rules)) ?></descrules>
    <?php endif; ?>
  </profiledesc>
</eadheader>
...
<archdesc <?php if ($resource->levelOfDescriptionId):?>level="<?php if (in_array(strtolower($levelOfDescription = $resource->getLevelOfDescription()->getName(array('culture' => 'en'))), $eadLevels)): ?><?php echo strtolower($levelOfDescription).'"' ?><?php else: ?><?php echo 'otherlevel" otherlevel="'.$levelOfDescription.'"' ?><?php endif; ?><?php endif; ?> relatedencoding="ISAD(G)v2">
  ...
  <odd type="<?php echo $xmlType ?>"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($note)) ?></p></odd>
    <?php endforeach;
    endif;
  }
  ...
  <odd type='bibseries'><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></odd>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getScopeAndContent(array('cultureFallback' => true)))): ?>
  <scopecontent encodinganalog="3.3.1"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></scopecontent><?php endif; ?>
  <?php if (0 < strlen($value = $resource->getArrangement(array('cultureFallback' => true)))): ?>
  <arrangement encodinganalog="3.3.4"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></arrangement><?php endif; ?>
  <?php
  ...
  <?php if ($event->getActor()->getEntityTypeId() == QubitTerm::PERSON_ID): ?>
    <persname role="<?php echo $event->getType()->getRole(array('cultureFallback' => true)) ?>"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars(render_title($event->getActor()))) ?></persname>
  <?php elseif ($event->getActor()->getEntityTypeId() == QubitTerm::FAMILY_ID): ?>
    <famname role="<?php echo $event->getType()->getRole(array('cultureFallback' => true)) ?>"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars(render_title($event->getActor()))) ?></famname>
  <?php else: ?>
    <corpname role="<?php echo $event->getType()->getRole(array('cultureFallback' => true)) ?>"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars(render_title($event->getActor()))) ?></corpname>
  <?php endif; ?>
  <?php endforeach; ?>
  <?php foreach ($names as $name): ?>
    <persname role="subject"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($name->getObject())) ?></persname>
  <?php endforeach; ?>
  <?php foreach ($materialtypes as $materialtype): ?>
    <genreform><?php echo preg_replace('/\n/', '<lb/>', preg_replace('/\n/', '<lb/>', esc_specialchars($materialtype->getTerm()))) ?></genreform>
  <?php endforeach; ?>
  <?php foreach ($subjects as $subject): ?>
    <subject<?php if ($subject->getTerm()->code):?> authfilenumber="<?php echo $subject->getTerm()->code ?>"<?php endif; ?><?php if ($ead->subjectHasNonBlankSourceNotes($subject)):?> source="<?php foreach ($subject->getTerm()->getSourceNotes() as $note): ?><?php echo $note ?><?php endforeach; ?>"<?php endif; ?>><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($subject->getTerm())) ?></subject>
  <?php endforeach; ?>
  <?php foreach ($places as $place): ?>
    <geogname><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($place->getTerm())) ?></geogname>
  <?php endforeach; ?>
  </controlaccess>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getPhysicalCharacteristics(array('cultureFallback' => true)))): ?>
  <phystech encodinganalog="3.4.3"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></phystech>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getAppraisal(array('cultureFallback' => true)))): ?>
  <appraisal encodinganalog="3.3.2"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></appraisal>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getAcquisition(array('cultureFallback' => true)))): ?>
  <acqinfo encodinganalog="3.2.4"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></acqinfo>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getAccruals(array('cultureFallback' => true)))): ?>
  <accruals encodinganalog="3.3.3"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></accruals>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getArchivalHistory(array('cultureFallback' => true)))): ?>
  <custodhist encodinganalog="3.2.3"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></custodhist>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getRevisionHistory(array('cultureFallback' => true)))): ?>
  <processinfo><p><date><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></date></p></processinfo>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getLocationOfOriginals(array('cultureFallback' => true)))): ?>
  <originalsloc encodinganalog="3.5.1"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></originalsloc>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getLocationOfCopies(array('cultureFallback' => true)))): ?>
  <altformavail encodinganalog="3.5.2"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></altformavail>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getRelatedUnitsOfDescription(array('cultureFallback' => true)))): ?>
  <relatedmaterial encodinganalog="3.5.3"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></relatedmaterial>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getAccessConditions(array('cultureFallback' => true)))): ?>
  <accessrestrict encodinganalog="3.4.1"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></accessrestrict>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getReproductionConditions(array('cultureFallback' => true)))): ?>
  <userestrict encodinganalog="3.4.2"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value))  ?></p></userestrict>
  <?php endif; ?>
  <?php if (0 < strlen($value = $resource->getFindingAids(array('cultureFallback' => true)))): ?>
  <otherfindaid encodinganalog="3.4.5"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></otherfindaid>
  <?php endif; ?>
  ...
  <bibliography encodinganalog="3.5.4"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($note)) ?></p></bibliography>
  <?php endforeach; ?>
  <?php endif; ?>
  ...
  <?php foreach ($resource->getDescendants()->orderBy('lft') as $descendant): ?>
    ...
    ?>
      ...
      <scopecontent encodinganalog="3.3.1"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></scopecontent>
      <?php endif; ?>
      <?php if (0 < strlen($value = $descendant->getArrangement(array('cultureFallback' => true)))): ?>
      <arrangement encodinganalog="3.3.4"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></arrangement>
      <?php endif; ?>
      <?php
      ...
      <?php if ($event->getActor()->getEntityTypeId() == QubitTerm::PERSON_ID): ?>
        <persname role="<?php echo $event->getType()->getRole() ?>"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars(render_title($event->getActor(array('cultureFallback' => true))))) ?> </persname>
      <?php elseif ($event->getActor()->getEntityTypeId() == QubitTerm::FAMILY_ID): ?>
        <famname role="<?php echo $event->getType()->getRole() ?>"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars(render_title($event->getActor(array('cultureFallback' => true))))) ?> </famname>
      <?php else: ?>
        <corpname role="<?php echo $event->getType()->getRole() ?>"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars(render_title($event->getActor(array('cultureFallback' => true))))) ?> </corpname>
      <?php endif; ?>
      <?php endforeach; ?>
      <?php foreach ($names as $name): ?>
        <persname role="subject"><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($name->getObject())) ?></persname>
      ...
      <phystech encodinganalog="3.4.4"><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($value)) ?></p></phystech>
      <?php endif; ?>
      ...
      <?php foreach ($archivistsNotes as $note): ?><processinfo><p><?php echo preg_replace('/\n/', '<lb/>', esc_specialchars($note)) ?></p></processinfo>
      <?php endforeach; ?>
      <?php endif; ?>
